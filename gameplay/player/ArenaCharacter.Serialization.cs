...
public class CharacterPublicState
{
    ...
    internal void Add(Message msg)
    {
        ...
        if ((Flags & CharacterPublicFlags.ROTATION_CHANGED) != 0) msg.Add(1);// NEED TO ADD VEC 2 TO MESSAGE
    ...
    internal void Write(Message msg)
    {
        ...
        if ((Flags & CharacterPublicFlags.ROTATION_CHANGED) != 0) msg.Write(1);// NEED TO ADD VEC 2 TO MESSAGE
    ...
    internal static CharacterPublicState Read(Message msg)
    {
        ...
        //if ((state.Flags & CharacterPublicFlags.ROTATION_CHANGED) != 0) msg.Read(out (byte)1);// NEED TO ADD VEC 2 TO MESSAGE
